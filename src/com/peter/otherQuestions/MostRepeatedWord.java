...
A word is defined as something separated by spaces without punctuation included.

Example: "She likes apples, bananas, and oranges." (The words are: {She, likes, apples, bananas, and, oranges})

A list of possible punctuation: "[\\n\\t\\r.,;:!?(){}]"

A list of common words we don't want to count: {"the", "a", "or", "an", "it", "and", "but", "is", "are", "of", "on", "to", "was", "were", "in", "that", "i", "your", "his", "their", "her", "you", "me", "all"}
*/
...
public class MostRepeatedWord {
    public static void main(String[] args) {
        ...
        findMostRepeatedWord(testString);// should return "lorem"
        ...
        findMostRepeatedWord(testString2);// should return "penguins"
        ...
        findMostRepeatedWord(testString3); // should return "used"
        ...
        String testString4 = "Sunday morning rain is falling\n" +
                ...
                "\n" +
                "Oh, yeah, yeah, oh\n";
        findMostRepeatedWord(testString4);// should return "morning"
        System.out.println();
        findMostRepeatedWord("peter");
    }
    ...
    public static String findMostRepeatedWord(String s) {
        ...
        String[] listOfWordsWeDontWantToCount = {"the", "a", "or", "an", "it", "and", "but", "is", "are", "of", "on", "to", "was", "were", "in", "that", "i", "your", "his", "their", "her", "you", "me", "all"};
        List<String> stringWeDoNotCountList = Arrays.asList(listOfWordsWeDontWantToCount);
        String listOfPunctuation = "[\\n\\t\\r\\s.,;:!?(){}]";
        String normalizedString = s.toLowerCase().trim();
        String[] stringArray = normalizedString.split(listOfPunctuation);
        HashMap<String, Integer> hashMap = new HashMap<>();
        for (String str : stringArray) {
            String tempStr = str.trim();
            if (tempStr.length() == 0 || stringWeDoNotCountList.contains(tempStr)) {
                continue;
            }
            if (!hashMap.containsKey(tempStr)) {
                hashMap.put(tempStr, 1);
            } else {
                hashMap.put(tempStr, hashMap.get(tempStr) + 1);
            }
        }
        int max = 0;
        ...
        System.out.println("Most repeated word: " + result + " | Repeated " + max + (max > 1 ? " times" : " time"));
        return result;
    }
}
